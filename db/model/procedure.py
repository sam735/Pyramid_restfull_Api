...
class FhirProc(Base):
    ...
    def __init__(self,procedure,jsonPayload):
        ...
        self.proc_status = procedure.status
        self.not_done = procedure.notDone
        self.perfomer_start_dt = convertStringToDateTime(procedure.performedDateTime)
        self.perfomer_start_dt = convertStringToDateTime(procedure.performedPeriod.start) if procedure.performedPeriod else None
        self.perfomer_end_dt = convertStringToDateTime(procedure.performedPeriod.end) if procedure.performedPeriod else None
        self.json_payload = str(jsonPayload)
        self.user_idn = 2
...
#     code_ = Column(String(100, u'SQL_Latin1_General_CP1_CI_AS'))
#     # crt_dt = Column(DateTime, nullable=False, server_default=("(getutcdate())"))
#     # upd_dt = Column(DateTime, nullable=False, server_default=("(getutcdate())"))
#     user_idn = Column(Numeric(18, 0), nullable=False)
#     entity_active = Column(ForeignKey(u'code_yn.yn_cd'), nullable=False, server_default=("('Y')"))
...
#     def __init__(self,codeObj = None, = None,fhir_idn = None,source = None,attribute = None):
...
class FhirCodeableConcept(Base):
    ...
    fhir_idn = Column(Numeric(18, 0), nullable=False)
    source = Column(String(200, 'SQL_Latin1_General_CP1_CI_AS'), nullable=False)
    attribute = Column(String(200, 'SQL_Latin1_General_CP1_CI_AS'), nullable=False)
...
#     fhir_identifier_idn = Column(Numeric(18, 0), primary_key=True)
#     fhir_idn = Column(Numeric(18, 0), nullable=False)
#     source = Column(String(200, 'SQL_Latin1_General_CP1_CI_AS'), nullable=False)
#     use = Column(String(15, 'SQL_Latin1_General_CP1_CI_AS'))
#     type = Column(Numeric(18, 0))
#     identifier_system = Column(String(100, 'SQL_Latin1_General_CP1_CI_AS'))
#     value = Column(String(100, 'SQL_Latin1_General_CP1_CI_AS'))
#     identifier_start_dt = Column(DateTime)
#     identifier_end_dt = Column(DateTime)
#     assigner = Column(Numeric(18, 0))
#     crt_dt = Column(DateTime, nullable=False, server_default=("(getutcdate())"))
...
#     fhir_note_idn = Column(Numeric(18, 0), primary_key=True)
#     fhir_idn = Column(Numeric(18, 0), nullable=False)
#     source = Column(String(200, 'SQL_Latin1_General_CP1_CI_AS'), nullable=False)
#     author_reference = Column(Numeric(18, 0))
#     author_string = Column(String(50, 'SQL_Latin1_General_CP1_CI_AS'))
#     note_crt_dt = Column(DateTime)
#     note_ = Column(String(100, 'SQL_Latin1_General_CP1_CI_AS'))
#     crt_dt = Column(DateTime, nullable=False, server_default=("(getutcdate())"))
#     upd_dt = Column(DateTime, nullable=False, server_default=("(getutcdate())"))
#     user_idn = Column(Numeric(18, 0), nullable=False)
#     entity_active = Column(ForeignKey('code_yn.yn_cd'), nullable=False, server_default=("('Y')"))
